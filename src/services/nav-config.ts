import {
  ...
  PenLine, Percent, PieChart, Radio, Scan, Settings, Share2, Shield, Sparkles, UserSearch, Users, Wallet,
...
export type NavSection = { title: string; icon: PlatformIcon; items: readonly NavItem[] }
...
export const navSections: readonly NavSection[] = [
  ...
  },
  {
    ...
    icon: PieChart,
    items: [
      ['/senal', 'Señal Pulse', Radio],
      ['/senal/coordinacion', 'Coordinación', Share2],
...
/** Sección accordion «Sistema» (Ajustes) — Diseño A · Graphite Signal */
export const sistemaSection: NavSection = {
  title: 'Sistema',
  icon: Settings,
  items: [settingsNav],
}
